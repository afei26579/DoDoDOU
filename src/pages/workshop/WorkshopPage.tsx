  ...
  return (
    <main className="workshop-page">
      ...
      <section className="workshop-panel card-surface" aria-label="参数设置">
        ...
        {mode === 'result' && patternResult ? <WorkshopResultStats patternResult={patternResult} /> : null}

        <WorkshopGenerateButton isGenerating={isGenerating} disabled={!uploadedImage || isGenerating} onClick={onGeneratePattern} />
      </section>
    </main>
  );
}
